...
!function (e) {
  ...
  r.cleanData = (n = r.cleanData, function (e) {
    ...
    for (var t, i, s = h.call(arguments, 1), n = 0, a = s.length; n < a; n++) {
      for (t in s[n]) {
        i = s[n][t], s[n].hasOwnProperty(t) && void 0 !== i && (r.isPlainObject(i) ? e[t] = r.isPlainObject(e[t]) ? r.widget.extend({}, e[t], i) : r.widget.extend({}, i) : e[t] = i);
      }
    }
    ...
    option: function option(e, t) {
      ...
      if ("string" == typeof e) if (a = {}, e = (i = e.split(".")).shift(), i.length) {
        for (s = a[e] = r.widget.extend({}, this.options[e]), n = 0; n < i.length - 1; n++) {
          s[i[n]] = s[i[n]] || {}, s = s[i[n]];
        }
    ...
    _setOptionClasses: function _setOptionClasses(e) {
      ...
      for (t in e) {
        s = this.classesElementLookup[t], e[t] !== this.options.classes[t] && s && s.length && (i = r(s.get()), this._removeClass(s, t), i.addClass(this._classes({
          element: i,
          keys: t,
          classes: e,
          add: !0
    ...
    _classes: function _classes(n) {
      ...
      function e(e, t) {
        for (var i, s = 0; s < e.length; s++) {
          i = o.classesElementLookup[e[s]] || r(), i = n.add ? r(r.unique(i.get().concat(n.element.get()))) : r(i.not(n.element).get()), o.classesElementLookup[e[s]] = i, a.push(e[s]), t && n.classes[e[s]] && a.push(n.classes[e[s]]);
        }
      }
    ...
    _trigger: function _trigger(e, t, i) {
      var s,
          n,
          a = this.options[e];
      if (i = i || {}, (t = r.Event(t)).type = (e === this.widgetEventPrefix ? e : this.widgetEventPrefix + e).toLowerCase(), t.target = this.element[0], n = t.originalEvent) for (s in n) {
        s in t || (t[s] = n[s]);
      }
    ...
    _handleEvents: {
      keydown: function keydown(e) {
        var t,
            i,
            s,
            n = r(e.target).data("ui-slider-handle-index");
